...
namespace data {
    ...
    template <typename X, typename elem = std::remove_const_t<decltype (*std::begin (std::declval<X> ())>>
    ...
    export struct reverse_iterator {
        iterator It;
...
namespace std {
    ...
    export struct iterator_traits<data::reverse_iterator<elem>> {
